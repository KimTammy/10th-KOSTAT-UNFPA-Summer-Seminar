...
KOR_pop <- read.table("data/standard/KOR.Population.txt",
                      header = T,skip = 2)
...
KOR_Mx <- read.table("data/standard/KOR.Mx_1x1.txt",
                     header = T,skip = 2)
...
KOR_fx <- read.table("data/standard/KORasfrRR.txt",
                     header = T,skip = 2)
...
KOR_Mx <- read.table("data/MortDecomp/KOR.Mx_1x1.txt",
                     header = T,skip = 2,fill = T)
